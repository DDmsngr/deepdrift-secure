...
class SocketService {
  ...
  Future<void> _registerFcmToken() async {
    try {
      ...
      if (fcmToken != null) {
        send({"type": "register_fcm_token", "fcm_token": fcmToken});
  ...
  void _scheduleReconnect() {
    ...
    _reconnectTimer = Timer(_getReconnectDelay(), () {
      _reconnectAttempts++;
      _attemptConnection();
    });
  }
  ...
  void sendMessage(String targetUid, String encText, String sign, String msgId, 
    ...
    send({
      "type": "message", "id": msgId, "target_uid": targetUid,
      "encrypted_text": encText, "signature": sign, "replyToId": replyToId,
      "messageType": messageType, "mediaData": mediaData,
  ...
  void sendEditMessage(String targetUid, String msgId, String newText, String newSign) {
    send({
      "type": "edit_message", "target_uid": targetUid, "message_id": msgId,
      "new_encrypted_text": newText, "new_signature": newSign
    });
  }

  void sendReaction(String targetUid, String msgId, String emoji, String action) {
    send({
      "type": "message_reaction", "target_uid": targetUid, "message_id": msgId,
